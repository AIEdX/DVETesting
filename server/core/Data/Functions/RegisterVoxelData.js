...
from;
"out/World/DivineVoxelEngineWorld.js"; //voxels
//voxels
...
export function RegisterVoxels(DVEW) {
    ...
    voxelData.push(
    //util
    DebugBoxVoxelData, LightDebugBoxVoxelData, DataHolderVoxelData, MarkerBoxVoxelData, 
    //dream
    DreamStoneVoxelData, DreamStonePillarVoxelData, DreamGrassBlockVoxelData, DreamLampVoxelData, DreamStoneSlabVoxelData, DreamLogVoxelData, DreamStoneStairVoxelData, DreamGrassVoxelData, DreamVineVoxelData, DreamLeafsVoxelData, LiquidDreamEtherVoxelData, 
    //dread
    DreadStoneVoxelData, DreadGrassBlockVoxelData, DreadGrassVoxelData, DreadLampVoxelData, DreadStonePillarVoxelData, LiquidDreadEtherVoxelData);
